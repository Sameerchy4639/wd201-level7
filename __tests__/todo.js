...
describe("todo test suits", () => {
  ...
  test("Test create a new todo", async () => {
    ...
    await login(agent, "sameer123@gmail.com", "sameer.4639");
  ...
  test("test delete one user todo by another user", async () => {
    ...
    await login(firstAgent, "sameer123@gmail.com", "sameer.4639");
    ...
    await login(secondUser, "sameer12@gmail.com", "8708892024");
